...
class TrayMenuBuilder:
    ...
    def build(self, tray_state: TrayState) -> Menu:
        ...
        return Menu(
            ...
            item("Debug: Record Mic", self._cb["toggle_save_audio"], checked=lambda i: tray_state.save_audio),
            item("Play Last Recording", self._cb["play_recording"], enabled=lambda i: tray_state.recording_exists),
